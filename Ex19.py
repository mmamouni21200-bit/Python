"""Definir una funció sumar_llista() i una funció multiplicar_llista() que sumin i 
multipliqueu, respectivament, tots els valors d’una llista. Prova-la amb diferents exemples. Ex: sumar_llista([1,2,3,4]) retorni 10.
"""
