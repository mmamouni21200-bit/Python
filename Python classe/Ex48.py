"""Definir una funció esta_ordenada() que donada una llista de números, ens indiqui si està ordenada en ordre ascendent, descendent o no està ordenada. Prova-la. Ex. esta_ordenada([3,2,1])
 retorni està ordenada de forma descendent. esta_ordenada([4,5,6]) """
