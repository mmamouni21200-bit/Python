""""Crear una funció que permeti llegir la informació d’un fitxer, però que controli que el fitxer existeix i que la seva obertura no doni cap problema. Fes-ho també utilitzant with. Si voleu podeu practicar el try, except afegint-ho a les funcions anteriors.
"""
